...
import au.com.snakerbone.block.entity.KunziteBlasterEntity;
...
public class KunziteBlasterBlock extends BlockWithEntity implements BlockEntityProvider {

    public static final DirectionProperty FACING = Properties.HORIZONTAL_FACING;

    public KunziteBlasterBlock(Settings settings) {
        super(settings);
    }
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof KunziteBlasterEntity) {
                ItemScatterer.spawn(world, pos, (KunziteBlasterEntity)blockEntity);
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new KunziteBlasterEntity(pos, state);
    }

    @Nullable
    @Override
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, ModBlockEntities.KUNZITE_BLASTER, KunziteBlasterEntity::tick);
    }
}
