...
public class KunziteBlasterScreen extends HandledScreen<KunziteBlasterScreenHandler> {
    private static final Identifier TEXTURE =
            new Identifier(SnakerBoneMod.MOD_ID, "textures/gui/kunzite_blaster_gui.png");

    public KunziteBlasterScreen(KunziteBlasterScreenHandler handler, PlayerInventory inventory, Text title) {
